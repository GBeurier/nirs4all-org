...
def validate_transition_copy(readme: str, index: str, release_page: str) -> None:
    ...
    required = {
        "README.md": (
            "nirs4all 1.1.3 is the Python V1 release.",
            "Studio 0.11.11",
            "Recovery pins the corrected nirs4all 1.1.3 library",
            'uses `engine="legacy"`',
            "schema-5 support",
            "0.11.11 manually and keep their",
            "DAG-ML 0.3.26 and dag-ml-data 0.2.11",
            "nirs4all-core 0.3.30, Methods 1.0.21 and IO 0.2.0",
        ...
        "index.html": (
            "https://github.com/GBeurier/nirs4all-studio/releases/tag/0.11.11",
            ...
            "nirs4all 1.1.3</b>",
            "Studio 0.11.11</b>",
            "corrected nirs4all 1.1.3 library and legacy execution",
